...
const Advertisement2 = () => (
    <div className="w-[1296px] h-[304px] bg-royalBlue flex flex-col items-center justify-center">
        <Image src={logoImage} height={122} width={293} alt={'Logo of TIX id'}/>
        <h4 className="text-2xl font-normal text-white mb-[18px]">Download Sekarang!</h4>
        <div className="flex gap-6">
            <Image src={googlePlay} alt={'Google Play badge'} height={50} width={200}/>
            <Image src={appStore} alt={'App Store badge'} height={50} width={200}/>
        </div>
    </div>)
