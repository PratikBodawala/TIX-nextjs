  ...
  return (
    <div className="p-20">
      ...
      <form className="w-[423px] my-16">
        <div className="mb-4">
          <label
            className="block text-shade900 text-lg font-normal mb-2 uppercase"
        ...
        <div className="flex flex-col items-center justify-between mt-16">
          ...
          <span className="text-xs mt-6 text-shade600">
            don&apos;t have account?
          </span>
          <button className="mt-2 font-default text-royalBlue rounded-[5px] border-[1px] border-shade600 text-xl font-medium w-full h-12">
            Create account
          </button>
        </div>
      </form>
